        ...
        <div className="flex flex-col gap-6 px-6 pt-24 h-full">
          ...
          {!isSignedIn && (
            <div className="flex flex-col gap-4 w-full">
              <Link href="/sign-in" className="flex items-center rounded-xl px-4 py-3.5 text-base font-medium text-white/80 hover:bg-white/10 transition-all border border-transparent hover:border-white/5" onClick={closeMenu}>
